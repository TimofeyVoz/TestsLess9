...
abstract public class MyListsPageObject extends MainPageObject {
    ...
    @Step("Open folder '{name_of_folder}' by name")
    ...
    @Step("Open saved article '{article_title}'")
    ...
    @Step("Search for a saved article by title '{article_title}'")
    public void waitForArticleToAppearByTitle(String article_title) {
        String article_xpath = getSavedArticleXpathByTitle(article_title);
        this.waitForElementPresent(article_xpath, "Cannot find saved article by title "+ article_title, 15);
    }

    @Step("Cheсking a saved article by title '{article_title}'")
    public void waitForArticleToDisappearByTitle(String article_title) {
        String article_xpath = getSavedArticleXpathByTitle(article_title);
        this.waitForElementNotPresent(article_xpath, "Saved article still present with title "+ article_title, 15);
    }

    @Step("Dell article '{article_title}' by swipe ")
